...
func _RealWorld_AddCommentsToArticle0_HTTP_Handler(srv RealWorldHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/realworld.v1.RealWorld/AddCommentsToArticle")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.AddCommentsToArticle(ctx, req.(*AddCommentsRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
func _RealWorld_GetCommentsFromArticle0_HTTP_Handler(srv RealWorldHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/realworld.v1.RealWorld/GetCommentsFromArticle")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
type RealWorldHTTPClient interface {
	AddCommentsToArticle(ctx context.Context, req *AddCommentsRequest, opts ...http.CallOption) (rsp *SingleCommentReply, err error)
	...
	GetCommentsFromArticle(ctx context.Context, req *GetCommentsFromArticleRequest, opts ...http.CallOption) (rsp *MultiCommentsReply, err error)
...
func (c *RealWorldHTTPClientImpl) AddCommentsToArticle(ctx context.Context, in *AddCommentsRequest, opts ...http.CallOption) (*SingleCommentReply, error) {
	var out SingleCommentReply
	pattern := "/api/articles/{slug}/comments"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation("/realworld.v1.RealWorld/AddCommentsToArticle"))
...
func (c *RealWorldHTTPClientImpl) DeleteComments(ctx context.Context, in *DeleteCommentsRequest, opts ...http.CallOption) (*SingleCommentReply, error) {
	var out SingleCommentReply
...
func (c *RealWorldHTTPClientImpl) GetCommentsFromArticle(ctx context.Context, in *GetCommentsFromArticleRequest, opts ...http.CallOption) (*MultiCommentsReply, error) {
	var out MultiCommentsReply
	pattern := "/api/articles/{slug}/comments"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation("/realworld.v1.RealWorld/GetCommentsFromArticle"))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
