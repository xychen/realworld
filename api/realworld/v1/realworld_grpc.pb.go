...
type RealWorldClient interface {
	...
	// 添加评论
	AddCommentsToArticle(ctx context.Context, in *AddCommentsRequest, opts ...grpc.CallOption) (*SingleCommentReply, error)
	// 获取文章下的评论
	GetCommentsFromArticle(ctx context.Context, in *GetCommentsFromArticleRequest, opts ...grpc.CallOption) (*MultiCommentsReply, error)
	// 删除评论
...
func (c *realWorldClient) AddCommentsToArticle(ctx context.Context, in *AddCommentsRequest, opts ...grpc.CallOption) (*SingleCommentReply, error) {
	out := new(SingleCommentReply)
	err := c.cc.Invoke(ctx, "/realworld.v1.RealWorld/AddCommentsToArticle", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *realWorldClient) GetCommentsFromArticle(ctx context.Context, in *GetCommentsFromArticleRequest, opts ...grpc.CallOption) (*MultiCommentsReply, error) {
	out := new(MultiCommentsReply)
	err := c.cc.Invoke(ctx, "/realworld.v1.RealWorld/GetCommentsFromArticle", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RealWorldServer interface {
	...
	// 添加评论
	AddCommentsToArticle(context.Context, *AddCommentsRequest) (*SingleCommentReply, error)
	// 获取文章下的评论
	GetCommentsFromArticle(context.Context, *GetCommentsFromArticleRequest) (*MultiCommentsReply, error)
	// 删除评论
...
func (UnimplementedRealWorldServer) AddCommentsToArticle(context.Context, *AddCommentsRequest) (*SingleCommentReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddCommentsToArticle not implemented")
}
func (UnimplementedRealWorldServer) GetCommentsFromArticle(context.Context, *GetCommentsFromArticleRequest) (*MultiCommentsReply, error) {
...
func _RealWorld_AddCommentsToArticle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/realworld.v1.RealWorld/AddCommentsToArticle",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RealWorldServer).AddCommentsToArticle(ctx, req.(*AddCommentsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RealWorld_GetCommentsFromArticle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/realworld.v1.RealWorld/GetCommentsFromArticle",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
